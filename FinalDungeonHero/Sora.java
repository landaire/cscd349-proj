/*This Sora class extends from Hero, inheriting all classes from it. Allows Sora to do specials also
 @ Extra Character
...
public class Sora extends Hero
{
	private double doubleSlash = .60;
	private int mindoubleSlash = 65;
	private int maxdoubleSlash = 185;
/**
...
/**
	   ...
	   @see		"No borrowed code"
*/			
	public Sora(String characterName, int hitPoint, int attackSpeed, double chanceToHitOpponent, int minDamage, int maxDamage, double chanceToBlock)
	{
...
/**
	   ...
	   @see		none
	  */		
	public int doubleSlashDamage()
	{
		Random generator = new Random();
		return generator.nextInt(maxdoubleSlash - mindoubleSlash) + mindoubleSlash;
	}//end calulations
/**
	   ...
	   @see		none
	  */	
	public boolean canDodoubleSlash()//if crushing blow is avaiable 
	{
		return Math.random()<= doubleSlash;
	}
/**
	   ...
	   @see		none
	  */	
	public void doubleSlash(DungeonCharacter opponent)
	{
		if(canDodoubleSlash())
		opponent.subtractHP(doubleSlashDamage());
